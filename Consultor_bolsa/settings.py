"""
Django settings for Consultor_bolsa project.
...
SECRET_KEY = 'django-insecure-19$&m_x4-^v$vi%647@4xzg6^s3y$e%yr901*xempymb8+j(3$'
...
AUTH_USER_MODEL = 'tela_cadastro.Usuario'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'monitoramento_acoes'),
